# 05 - calculating consistency of grid cells in terms of spawning habitat suitability
...
###### SKIP FOR NOW #########################################################################
 ...
 #### hindcasts ####	
  ...
  #### maps of consistency averaged across recent 20 years and last 20 years ####
  ...
  #05 Potential habitat 
	...
	consistency_maps05 <- current20_hist05 + last20_hist05 + 
  ...
  consistency_maps05_form <- consistency_maps05 + 
  	...
  	annotate("text", label = (paste("Potential habitat\n(spawning habitat\nsuitability", 
			 symbol, "0.5)", sep =" ")), x = -5.82, y = 0.7, size = 2, fontface = 2, hjust = 0,
			 color = "#01579B") +
