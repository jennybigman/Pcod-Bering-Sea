# 08 - trends of habitat suitability metrics
  ...
  sphabsuit2020$mean_hab_suit - sphabsuit1970$mean_hab_suit
	...
	# projection
	yearly_hab_dat_proj_ssp126 <- yearly_hab_dat_proj %>%
		filter(projection == "ssp126")
	
	proj_habsuit_lm_ssp126 <- lm(mean_hab_suit ~ year, data = yearly_hab_dat_proj_ssp126)
	
	confint(proj_habsuit_lm_ssp126)
	summary(proj_habsuit_lm_ssp126)

	# high emission
	yearly_hab_dat_proj_ssp585 <- yearly_hab_dat_proj %>%
		filter(projection == "ssp585")
	
	proj_habsuit_lm_ssp585 <- lm(mean_hab_suit ~ year, data = yearly_hab_dat_proj_ssp585)
	
	confint(proj_habsuit_lm_ssp585)
	summary(proj_habsuit_lm_ssp585)
