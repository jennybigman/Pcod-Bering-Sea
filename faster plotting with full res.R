# faster plotting
    ...
    ID_func <- function(x){
    	IDin <- paste0(x, "_subgrid_all_cells")
    	paste0("_", IDin)
    }
  ...
  monthly_plot_list <- lapply(df_sf_list, monthly_plot)
   ...
   mo_name_func <- function(x){
   	year_month <- paste0(x, "_bottom_temp_monthly_all_gridcells")
   }
 ...
 setwd("~/Google Drive/NOAA AFSC Postdoc/Pcod Bering Sea Habitat Suitability/Pcod-Bering-Sea/output/plots/weekly plots")
   ...
   wk_name_func <- function(x){
   	year_month <- paste0(x, "_bottom_temp_weekly_all_gridcells")
   }
  ...
  monthly_plot_hs_list <- lapply(df_sf_list, monthly_plot_hs)
   ...
   mo_name_func <- function(x){
   	year_month <- paste0(x, "_hatch_success_monthly_all_gridcells")
   }
 ...
 setwd("~/Google Drive/NOAA AFSC Postdoc/Pcod Bering Sea Habitat Suitability/Pcod-Bering-Sea/output/plots/weekly plots")
   ...
   wk_name_func <- function(x){
   	year_month <- paste0(x, "_hatch_success_weekly_all_gridcells")
   }
