# animate habitat suitability plots
  ...
  month_names_year <- sapply(years_hind, mo_name_func_year)
	...
	mo_name_func_file <- function(x){
  	year_month <- paste0("/Users/jenniferbigman/My Drive/NOAA AFSC Postdoc/Pcod Bering Sea Habitat Suitability/Pcod-Bering-Sea/output/plots/animation/sequence/hindcast/", x)
  }
  ...
  ggsave_func <- function(x,y){
	...
	dir_out <- ("~/My Drive/NOAA AFSC Postdoc/Pcod Bering Sea Habitat Suitability/Pcod-Bering-Sea/output/plots/animation/sequence/hindcast")
  ...
  month_names_year <- sapply(years_proj, mo_name_func_year)
	...
	mo_name_func_file <- function(x){
  	year_month <- paste0("/Users/jenniferbigman/My Drive/NOAA AFSC Postdoc/Pcod Bering Sea Habitat Suitability/Pcod-Bering-Sea/output/plots/animation/sequence/projection/", x)
  }
  ...
  ggsave_func2 <- function(x,y){
	...
	dir_out <- ("~/My Drive/NOAA AFSC Postdoc/Pcod Bering Sea Habitat Suitability/Pcod-Bering-Sea/output/plots/animation/sequence/projection")
