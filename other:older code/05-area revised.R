# area metric 
	...
	proj_area_yr$scen[proj_area_yr$projection == "ssp126"] <- "low emission (ssp126)"
	proj_area_yr$scen[proj_area_yr$projection == "ssp585"] <- "high emission (ssp585)"
	...
	# order facets
	proj_area_yr$scen_f = factor(proj_area_yr$scen, levels=c('low emission (ssp126)', 'high emission (ssp585)'))
...
fancy_scientific <- function(l) {
    ...
    theme_bw() +
  	...
  	theme(
		...
		ggsave("./output/plots/area_plot.png",
			 area_plot,
